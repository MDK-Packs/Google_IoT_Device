...
// Compute signature using ECSDA and SHA-256
...
static int es256_sign (mbedtls_pk_context *pk,
  ...
  // Compute signature
  rc = mbedtls_ecdsa_sign_det(&ecdsa.grp, &r, &s, &ecdsa.d,
...
// Compute signature using RSASSA-PKCS1 and SHA-256
